<?php
	...
	$sql = "SELECT * FROM voiture WHERE id = 11"; // Changez l'ID selon votre base
	...
	<div id="section">
		<div class="container">
			<div id="carrousel" align="center">
				<div class = "photo">
					<ul>
						<li><img src="Images/Voitures/ami/ami.jpg" alt = "ami " width="700" height="400"/></li>
						<li><img src="Images/Voitures/ami/ami_2.jpg" alt = "ami " width="700" height="400"/></li>
						<li><img src="Images/Voitures/ami/ami_3.jpg" alt = "ami " width="700" height="400"/></li>
						<li><img src="Images/Voitures/ami/ami_4.jpg" alt = "ami " width="700" height="400"/></li>
						<li><img src="Images/Voitures/ami/ami_5.jpg" alt = "ami " width="700" height="400"/></li>
						<li><img src="Images/Voitures/ami/ami_6.jpg" alt = "ami " width="700" height="400"/></li>
					</ul>
				</div>
			</div>
			...
			<div class="details">
				...
				<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
					...
					<input type="hidden" name="modele" value="Ami">
