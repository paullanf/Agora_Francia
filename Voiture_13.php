...
if (isset($_GET['query'])) {
	...
	$sql = "SELECT * FROM voiture WHERE id = 13"; // Changez l'ID selon votre base
...
<div id="section">
	<div class="container">
		<div id="carrousel" align="center">
			<div class = "photo">
				<ul>
					<li><img src="Images/Voitures/gt3_rs/gt3_rs.jpg" alt = "gt3_rs " width="700" height="400"/></li>
					<li><img src="Images/Voitures/gt3_rs/gt3_rs_2.jpg" alt = "gt3_rs " width="700" height="400"/></li>
					<li><img src="Images/Voitures/gt3_rs/gt3_rs_3.jpg" alt = "gt3_rs " width="700" height="400"/></li>
					<li><img src="Images/Voitures/gt3_rs/gt3_rs_4.jpg" alt = "gt3_rs " width="700" height="400"/></li>
					<li><img src="Images/Voitures/gt3_rs/gt3_rs_5.jpg" alt = "gt3_rs " width="700" height="400"/></li>
				</ul>
			</div>
		</div>
		...
		<div class="details">
			...
			<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
				...
				<input type="hidden" name="modele" value="GT3 RS">
