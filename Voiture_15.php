...
if (isset($_GET['query'])) {
	...
	$sql = "SELECT * FROM voiture WHERE id = 15"; // Changez l'ID selon votre base
...
<div id="section">
	<div class="container">
		<div id="carrousel" align="center">
			<div class = "photo">
				<ul>
					<li><img src="Images/Voitures/megane/megane.jpg" alt = "megane " width="700" height="400"/></li>
					<li><img src="Images/Voitures/megane/megane_2.jpg" alt = "megane " width="700" height="400"/></li>
					<li><img src="Images/Voitures/megane/megane_3.jpg" alt = "megane " width="700" height="400"/></li>
				</ul>
			</div>
		</div>
		...
		<div class="details">
			...
			<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
				...
				<input type="hidden" name="modele" value="Megane">
