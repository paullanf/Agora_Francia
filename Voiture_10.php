<?php
	...
	$sql = "SELECT * FROM voiture WHERE id = 10"; // Changez l'ID selon votre base
	...
	<div id="section">
		<div class="container">
			<div id="carrousel" align="center">
				<div class = "photo">
					<ul>
						<li><img src="Images/Voitures/corsa/corsa.jpg" alt = "corsa " width="700" height="400"/></li>
						<li><img src="Images/Voitures/corsa/corsa_2.jpg" alt = "corsa " width="700" height="400"/></li>
						<li><img src="Images/Voitures/corsa/corsa_3.jpg" alt = "corsa " width="700" height="400"/></li>
						<li><img src="Images/Voitures/corsa/corsa_4.jpg" alt = "corsa " width="700" height="400"/></li>
						<li><img src="Images/Voitures/corsa/corsa_5.jpg" alt = "corsa " width="700" height="400"/></li>
					</ul>
				</div>
			</div>
			...
			<div class="details">
				...
				<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
					...
					<input type="hidden" name="modele" value="Corsa">
