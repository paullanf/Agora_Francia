<?php
	...
	$sql = "SELECT * FROM voiture WHERE id = 6"; // Changez l'ID selon votre base
	...
	<div id="section">
		<div class="container">
			<div id="carrousel" align="center">
				<div class = "photo">
					<ul>
						<li><img src="Images/Voitures/rs6/rs6.jpg" alt = "Audi RS6 "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/rs6/rs6_2.jpg" alt = "Audi RS6 "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/rs6/rs6_3.jpg" alt = "Audi RS6 "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/rs6/rs6_4.jpg" alt = "Audi RS6 "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/rs6/rs6_5.jpg" alt = "Audi RS6 "  width="700" height="400.jpg"/></li>
					</ul>
				</div>
			</div>
