<?php
	...
	$sql = "SELECT * FROM voiture WHERE id = 9"; // Changez l'ID selon votre base
	...
	<div id="section">
		<div class="container">
			<div id="carrousel" align="center">
				<div class = "photo">
					<ul>
						<li><img src="Images/Voitures/expert/expert.jpg" alt = "Expert " width="700" height="400"/></li>
						<li><img src="Images/Voitures/expert/expert_2.jpg" alt = "Expert " width="700" height="400"/></li>
						<li><img src="Images/Voitures/expert/expert_3.jpg" alt = "Expert " width="700" height="400"/></li>
						<li><img src="Images/Voitures/expert/expert_4.jpg" alt = "Expert " width="700" height="400"/></li>
						<li><img src="Images/Voitures/expert/expert_5.jpg" alt = "Expert " width="700" height="400"/></li>
					</ul>
				</div>
			</div>
			...
			<div class="details">
				...
				<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
					...
					<input type="hidden" name="modele" value="Expert">
