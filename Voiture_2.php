<?php
	...
	$sql = "SELECT * FROM voiture WHERE id = 2"; // Changez l'ID selon votre base
	...
	<div id="section">
		<div class="container">
			<div id="carrousel" align="center">
				<div class = "photo">
					<ul>
						<li><img src="Images/Voitures/m2/m2.jpg" alt = "BMW M2 "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/m2/m2_2.jpg" alt = "Peugeot 2008 "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/m2/m2_3.jpg" alt = "Fiat 500 "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/m2/m2_4.jpg" alt = "BMW M2 "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/m2/m2_5.jpg" alt = "Audi RS6 "  width="700" height="400.jpg"/></li>
					</ul>
				</div>
			</div>
			...
			<div class="details">
				...
				<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
					...
					<input type="hidden" name="modele" value="M2 f87">
