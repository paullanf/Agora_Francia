...
if (isset($_GET['query'])) {
	...
	$sql = "SELECT * FROM voiture WHERE id = 12"; // Changez l'ID selon votre base
...
<div id="section">
	<div class="container">
		<div id="carrousel" align="center">
			<div class = "photo">
				<ul>
					<li><img src="Images/Voitures/leaf/leaf.jpg" alt = "leaf " width="700" height="400"/></li>
					<li><img src="Images/Voitures/leaf/leaf_2.jpg" alt = "leaf " width="700" height="400"/></li>
					<li><img src="Images/Voitures/leaf/leaf_3.jpg" alt = "leaf " width="700" height="400"/></li>
					<li><img src="Images/Voitures/leaf/leaf_4.jpg" alt = "leaf " width="700" height="400"/></li>
					<li><img src="Images/Voitures/leaf/leaf_5.jpg" alt = "leaf " width="700" height="400"/></li>
				</ul>
			</div>
		</div>
		...
		<div class="details">
			...
			<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
				...
				<input type="hidden" name="modele" value="Leaf">
