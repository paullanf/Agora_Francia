<?php
	...
	$sql = "SELECT * FROM voiture WHERE id = 3"; // Changez l'ID selon votre base
	...
	<div id="section">
		<div class="container">
			<div id="carrousel" align="center">
				<div class = "photo">
					<ul>
						<li><img src="Images/Voitures/500/500.jpg" alt = "Fiat 500  " width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/500/500_2.jpg" alt = "Fiat 500 "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/500/500_3.jpg" alt = "Fiat 500  "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/500/500_4.jpg" alt = "Fiat 500  "  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/500/500_5.jpg" alt = "Fiat 500"  width="700" height="400.jpg"/></li>
					</ul>
				</div>
			</div>
			...
			<div class="details">
				...
				<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
					...
					<input type="hidden" name="modele" value="Fiat 500">
