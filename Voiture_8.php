<?php
	...
	$sql = "SELECT * FROM voiture WHERE id = 8"; // Changez l'ID selon votre base
	...
	<div id="section">
		<div class="container">
			<div id="carrousel" align="center">
				<div class = "photo">
					<ul>
						<li><img src="Images/Voitures/c3/c3.jpg" alt = "c3 " width="700" height="400"/></li>
						<li><img src="Images/Voitures/c3/c3_2.jpg" alt = "c3 " width="700" height="400"/></li>
						<li><img src="Images/Voitures/c3/c3_3.jpg" alt = "c3" width="700" height="400"/></li>
						<li><img src="Images/Voitures/c3/c3_4.jpg" alt = "c3 " width="700" height="400"/></li>
					</ul>
				</div>
			</div>
			...
			<div class="details">
				...
				<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
					...
					<input type="hidden" name="modele" value="C3">
