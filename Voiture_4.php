<?php
	...
	$sql = "SELECT * FROM voiture WHERE id = 4"; // Changez l'ID selon votre base
	...
	<div id="section">
		<div class="container">
			<div id="carrousel" align="center">
				<div class = "photo">
					<ul>
						<li><img src="Images/Voitures/huracan/huracan.jpg" alt = "Lamborghini Huracan"  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/huracan/huracan_2.jpg" alt = "Lamborghini Huracan"  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/huracan/huracan_3.jpg" alt = "Lamborghini Huracan"  width="700" height="400.jpg"/></li>
						<li><img src="Images/Voitures/huracan/huracan_4.jpg" alt = "Lamborghini Huracan"  width="700" height="400.jpg"/></li>
					</ul>
				</div>
			</div>
			...
			<div class="details">
				...
				<form id="formulaire_proposition" action = "panier.php" method="POST" style="display:none;">
					...
					<input type="hidden" name="modele" value="Huracan">
